...
public class Controlador_RecetaMedica{
    public static Conexion_BaseDatos_RecetaMedica conexion = new Conexion_BaseDatos_RecetaMedica();
    ...
    public int guardar(String tituloDiagnostico,String medicamentos,String diaFecha,String mesFecha,String añoFecha,String nombrePaciente,String apellidoPaternoPaciente,String apellidoMaternoPaciente){
        int resultado = 0;
        Connection cn = null;
        String sentenciaGuardar = "INSERT INTO receta(tituloDiagnostico,medicamentos,diaFecha,mesFecha,añoFecha,nombrePaciente,apellidoPaternoPaciente,apellidoMaternoPaciente) VALUES(?,?,?,?,?,?,?,?)";
        try{
